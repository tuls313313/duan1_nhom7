        ...
        <form action="?act=nextdangnhap" method="POST" class="form" id="form-2">
          ...
          <div class="form-group">
            ...
            <?php if (isset($_SESSION['email_err'])): ?>
              <p class="btn btn-danger"><?= $_SESSION['email_err']; ?></p>
          ...
          <div class="form-group matkhau">
            ...
            <?php if (isset($_SESSION['password_err'])): ?>
              <p class="btn btn-danger"><?= $_SESSION['password_err']; ?></p>
              <?php unset($_SESSION['password_err']); ?>
            <?php endif; ?>
          </div>
          <button class="form-submit btn-blocker" name="submit" style="border-radius: unset;">ĐĂNG NHẬP <i
