                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-success mb-2" href="?act=admin/size/addSize">Add size</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning"
                                                    href="?act=admin/size/edit&id=<?= $value['id'] ?>">Sửa</a>
                                                <a class="btn btn-danger"
                                                    onclick="return confirm('Bạn chắc chắn muốn xóa màu: <?= $value['name'] ?> ?');"
                                                    href="?act=admin/size/delete&id=<?= $value['id'] ?>">Xóa</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
