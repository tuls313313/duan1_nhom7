    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" value="<?php echo $dataOneUser['email']; ?>" readonly>
        </div>
        <div class="form-group">
        ...
        <button type="submit" name="editUser" onclick="return confirm('Bạn chắc chắn muốn sửa cho user: <?php echo $dataOneUser['user']; ?> ');" class="btn btn-success">Edit</button>
    </form>
          <!-- /.card -->
        </div>
        <!-- /.col -->
